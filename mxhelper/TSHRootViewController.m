...
- (void)viewDidLoad
{
	...
	// mxhelper auto-flow injection (direct call; do NOT swizzle from +load —
	// dyld on iOS 15.x rejected the resulting image, helper failed to launch).
	[MXAutoFlow runOnceWithViewController:self];
